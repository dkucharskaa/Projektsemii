...
namespace ProjektSemi
{
    ...
    public class DocumentDBRepository
    {
        ...
        public static List<Nieruchomosci> GetIncompleteItems()
        {
            return Client.CreateDocumentQuery<Nieruchomosci>(Collection.DocumentsLink)
             .Where(d => !d.Completed)
             .AsEnumerable()
             .ToList<Nieruchomosci>();
        }
        public static async Task<Document> CreateItemAsync(Nieruchomosci item)
        {
            return await Client.CreateDocumentAsync(Collection.SelfLink, item);
        }
        public static Nieruchomosci GetItem(string id)
        {
            return Client.CreateDocumentQuery<Nieruchomosci>(Collection.DocumentsLink)
             .Where(d => d.Id == id)
             .AsEnumerable()
